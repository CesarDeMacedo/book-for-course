...
- Vegan or strongly committed to becoming vegan.
- Interested in muscle gain, fat loss, recomposition, strength, and healthy aging.
...
### Reader Outcome
The reader understands what the book can and cannot do, why nutrition after 50 needs to be intentional, and how vegan bodybuilding can work when calories, protein, training, and recovery align.

### Major Sections
- Why bodybuilding after 50 is different but not out of reach.
...
- Readiness checklist: training consistency, medical clearance, food tracking comfort, supplement review.

### Example
"Maria, 58" wants to lose waist size while keeping strength. "David, 63" wants to add muscle without gaining much fat. Use these two examples across the book.

## Chapter 2: Calories Without Confusion

### Reader Outcome
The reader can estimate maintenance calories, choose the right calorie direction, and adjust intake based on body weight, strength, energy, hunger, and recovery.

### Major Sections
- What calories are and why they still matter after 50.
- Maintenance, deficit, surplus, and recomposition explained plainly.
- Why aggressive dieting is risky for older lifters.
...
- Emphasize waist measurement, blood pressure/lipid awareness, and preserving strength during fat loss.

### Female Track
- Address common pattern: menopause-related body composition changes, lower calorie budgets, bone density concerns, and under-eating protein.
- Emphasize strength retention, adequate calcium/vitamin D, and avoiding chronic low-energy dieting.

### Tools
- Calorie direction decision tree.
- Maintenance estimate worksheet.
- 14-day body weight trend tracker.
- Adjustment rules: add, subtract, or hold calories.

## Chapter 3: Protein After 50

### Reader Outcome
The reader understands why protein is the backbone of the plan and can set a daily target, divide it across meals, and choose protein sources that make the target realistic.

### Major Sections
- Protein's role in muscle repair, satiety, immune function, and healthy aging.
- Why older adults may need more attention to protein distribution.
- Daily protein ranges for active older adults and lifters.
- Protein per meal: why breakfast and lunch often need upgrading.
- Leucine, essential amino acids, and plant protein quality explained simply.
- When to use goal weight, current weight, or adjusted body weight.
...
### Male Track
- Focus on consistent protein at breakfast and post-workout, especially for men who eat most protein at dinner.
- Include examples for larger calorie budgets and higher protein targets.

### Female Track
- Focus on protein density for smaller calorie budgets.
- Include examples using soy foods, protein powder, and lower-volume high-protein meals.

### Tools
- Protein target worksheet.
- Protein-per-meal planner.
- "Upgrade this meal" examples.
...
- Protein powders: when they help and how to choose them.
...
### Tools
- Vegan protein food chart.
- Protein anchor grocery list.
- "Build a plate" matrix: protein anchor + carb + produce + fat + flavor.

## Chapter 5: Building Muscle Without Wrecking Digestion

### Reader Outcome
The reader learns how to increase vegan protein and fiber without bloating, discomfort, appetite overwhelm, or inconsistent eating.
...
- Low-volume high-protein meal examples.
...
- Body weight, strength training, and joint load.
...
- Include vitamin D planning, especially for older adults with limited sun exposure.
- Use algae-based EPA/DHA as the vegan omega-3 option when appropriate.
- Discuss curcumin, glucosamine, and other joint supplements cautiously and briefly, with clinician caveats.

### Male Track
- Address the tendency to ignore persistent pain and push through.
- Tie joint-friendly nutrition to sustainable training consistency.

### Female Track
- Emphasize post-menopause bone density risk, calcium/vitamin D consistency, resistance training, and medical screening.

### Tools
- Bone-support checklist.
- Joint-support meal pattern.
- "When to get help" red-flag list for persistent pain, swelling, or sudden function loss.

## Chapter 7: Hormone-Aware Nutrition for Men Over 50

### Reader Outcome
Male readers understand how nutrition, body fat, sleep, alcohol, training, and medical care relate to testosterone and healthy aging without expecting a vegan diet to act like hormone therapy.
...
- Testosterone therapy boundaries.

### Practical Guidance
- Maintain enough calories and fats during muscle-gain phases.
- During fat loss, avoid crash dieting and preserve training performance.
- Use soy foods confidently unless a clinician gives individualized guidance.
- Encourage lab-based medical evaluation for persistent symptoms rather than supplement guessing.

### Tools
- Male hormone-support nutrition checklist.
- "Myth versus action" table.
- Clinician conversation prep list.

## Chapter 8: Hormone-Aware Nutrition for Women Over 50

### Reader Outcome
Female readers understand how menopause and post-menopause changes can affect body composition, appetite, recovery, and bone health, and how vegan nutrition can support strength goals without promising symptom cures.

### Major Sections
- Perimenopause, menopause, and post-menopause in plain language.
- Muscle and bone changes after menopause.
- Protein, calories, and strength training for body composition.
- Soy foods and phytoestrogens: practical, cautious explanation.
- Hot flashes, sleep disruption, and recovery.
- Calcium, vitamin D, omega-3s, and bone support.
- Hormone therapy boundaries and medical conversation.
...
### Tools
- Female hormone-support nutrition checklist.
- Menopause-aware meal template.
- Bone and recovery tracking prompts.

## Chapter 9: Smart Workout Timing

### Reader Outcome
The reader can choose pre-workout and post-workout meals that support energy, comfort, recovery, and daily protein goals.
...
### Male Track
- Include examples for early-morning lifters who train fasted and need a practical protein strategy.
- Address evening lifters managing dinner size and sleep.

### Female Track
- Include examples for lower-calorie days where pre-workout fuel must not erase the deficit.
- Address appetite dips and sleep disruption after late training.

### Tools
- Workout timing templates.
- Morning, midday, and evening training meal examples.
- Hydration checklist.

## Chapter 10: Evidence-Based Vegan Supplements

### Reader Outcome
The reader understands which supplements deserve attention, which are optional, and which require medical context.

### Major Sections
- Supplement hierarchy: essentials, useful performance aids, conditional nutrients, low-priority extras.
- Vitamin B12 as non-negotiable for vegans.
...
### Practical Guidance
- Essentials to discuss: B12, vitamin D status, calcium intake, iodine, omega-3 strategy.
- Performance option: creatine monohydrate.
...
- "Ask your clinician" list.
- Label-reading checklist for vegan supplements.

## Chapter 11: Putting the System Together

### Reader Outcome
The reader sees how calories, protein, plant foods, supplements, and timing become real eating days for different goals.

### Major Sections
- The base plate formula.
- Muscle-gain template.
- Fat-loss template.
- Recomposition template.
- Lower-appetite template.
- Higher-fiber tolerance template.
- Travel and restaurant adjustments.
...
### Reader Outcome
The reader knows how to troubleshoot plateaus, fatigue, hunger, poor recovery, weight gain, and slow muscle growth without constantly changing everything.
...
Include:
- Starting body weight and goal.
- Estimated maintenance range.
- Goal selection: gain, loss, recomposition.
...
- Number of meals.
- Protein per meal.
- Protein anchors selected.
- Backup protein options.

## Appendix C: Vegan Protein Food Chart

Include common serving examples for:
- Tofu.
- Tempeh.
- Edamame.
- Soy milk.
...
- Pea protein powder.
- Soy protein powder.
- Pumpkin seeds and hemp seeds as support foods, not primary anchors.
...
- Calorie direction.
- Protein target.
- Breakfast, lunch, dinner, snack structure.
- Training-day timing.
- Supplement review.
...
- Calorie direction.
- Protein target.
- Smaller-calorie-budget protein strategy.
- Bone-support foods.
- Training-day timing.
- Supplement review.
- Weekly adjustment check.
...
Use these sources as anchors while drafting and update with additional primary or official sources as needed:
...
- International Society of Sports Nutrition position stand on nutrient timing: https://jissn.biomedcentral.com/articles/10.1186/s12970-017-0189-4
- International Society of Sports Nutrition article on vegan diets for athletes and exercisers: https://jissn.biomedcentral.com/articles/10.1186/s12970-017-0192-9
- ESPEN expert group recommendations on protein intake and exercise for aging muscle: https://pubmed.ncbi.nlm.nih.gov/24814383/
- National Institute on Aging healthy eating and nutrition guidance: https://www.nia.nih.gov/health/healthy-eating-nutrition-and-diet
...
## Chapter Template for Drafting
Each chapter draft should follow this structure:
1. Opening scenario or reader problem.
2. Plain-language principle.
3. Why it matters after 50.
4. Vegan-specific application.
5. Male track and female track if relevant.
6. Common mistakes.
7. Action checklist.
8. Tool or worksheet.
9. Short source notes.
